...
class CasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create case" do
    assert_difference("Case.count") do
      post cases_url, params: { case: { admission_identifier: @case.admission_identifier, description: @case.description } }
    end
  ...
  test "should update case" do
    patch case_url(@case), params: { case: { admission_identifier: @case.admission_identifier, description: @case.description } }
